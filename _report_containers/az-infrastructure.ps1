...
az webapp create -g $RG -p $PLAN -n $APIAPP --deployment-container-image-name mcr.microsoft.com/dotnet/aspnet:8.0
az webapp create -g $RG -p $PLAN -n $WEBAPP --deployment-container-image-name mcr.microsoft.com/dotnet/aspnet:8.0
