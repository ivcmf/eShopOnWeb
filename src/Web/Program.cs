...
// Order Reserve options + HttpClient
builder.Services.Configure<OrderReserveOptions>(
builder.Configuration.GetSection("OrderReserve"));
builder.Services.AddHttpClient<IOrderReserveClient, OrderReserveClient>();
